    ...
    <div class="default-main">
                ...
                <el-col :lg="6" class="hidden-md-and-down">
                    <div class="working">
                        ...
                        <div class="working-text">
                            {{ t('dashboard.You have worked today') }}<span class="time">{{
            ...
            <el-row :gutter="20">
                <el-col :sm="12" :lg="6">
                    <div class="small-panel user-reg suspension">
                        <div class="small-panel-title">{{ t('dashboard.TotalNumberOfDeviceActivations') }}</div>
                ...
                <el-col :sm="12" :lg="6">
                    <div class="small-panel file suspension">
                        <div class="small-panel-title">{{ t('dashboard.DeviceActivationsToday') }}</div>
                        <div class="small-panel-content">
                            <div class="content-left">
                ...
                <el-col :sm="12" :lg="6">
                    <div class="small-panel users suspension">
                        <div class="small-panel-title">{{ t('dashboard.LoginToday') }}</div>
                        <div class="small-panel-content">
                            <div class="content-left">
                ...
                <el-col :sm="12" :lg="6">
                    <div class="small-panel addons suspension">
                        <div class="small-panel-title">{{ t('dashboard.OnlineUser') }}</div>
                        <div class="small-panel-content">
                            <div class="content-left">
        ...
        <div class="growth-chart">
            <el-row :gutter="20">
                <el-col class="lg-mb-20" :xs="24" :sm="24" :md="12" :lg="9">
                    <el-card shadow="hover" :header="t('dashboard.EquipmentGrowth')">
                        <div class="user-growth-chart" :ref="chartRefs.set"></div>
                    </el-card>
                </el-col>
                <el-col class="lg-mb-20" :xs="24" :sm="24" :md="12" :lg="9">
                    <el-card shadow="hover" :header="t('dashboard.DeviceActivation')">
                            ...
                            <el-scrollbar>
                                <div class="new-user-item">
                                    ...
                                    <div class="new-user-base">
                                        <div class="new-user-name">小明</div>
                                        <div class="new-user-time">1分钟前{{ t('dashboard.Joined us') }}</div>
                                    </div>
                                ...
                                <div class="new-user-item">
                                    <img class="new-user-avatar" src="~assets/login-header.png" alt=""/>
                                    <div class="new-user-base">
                                        <div class="new-user-name">小红</div>
                                        <div class="new-user-time">2分钟前{{ t('dashboard.Joined us') }}</div>
                                    </div>
                                    <Icon class="new-user-arrow" color="#8595F4" name="fa fa-angle-right"/>
                                </div>
                                <div class="new-user-item">
                                    <img class="new-user-avatar" src="~assets/login-header.png" alt=""/>
                                    <div class="new-user-base">
                                        <div class="new-user-name">小黑</div>
                                        <div class="new-user-time">5分钟前{{ t('dashboard.Joined us') }}</div>
                                    </div>
                                    <Icon class="new-user-arrow" color="#8595F4" name="fa fa-angle-right"/>
                                </div>
                                <div class="new-user-item">
                                    ...
                                    <div class="new-user-base">
                                        <div class="new-user-name">小李</div>
        ...
        <div class="growth-chart">
            <el-row :gutter="20">
                ...
                <el-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="12">
                    <el-card shadow="hover" :header="t('dashboard.MemberDistribution')">
