export default {
    ...
    'TotalNumberOfDeviceActivations': '设备激活总数',
    'OnlineUser': '在线用户',
    'DeviceActivationsToday': '今日设备激活数',
    'LoginToday': '今日登陆',
    'RegionalDistributionOfEquipmentToday': '今日设备区域分布',
    'EquipmentGrowth': '设备增长情况',
    'DeviceActivation': '设备激活情况',
}
