    ...
    <div class="nav-menus" :class="configStore.layout.layoutMode">
        ...
        >
            <div class="nav-menu-item pt2" :class="state.currentNavMenu == 'lang' ? 'hover' : ''">
                <Icon :color="configStore.getColorVal('headerBarTabColor')" class="nav-menu-icon" name="local-lang"
                      size="18"/>
            </div>
            <template #dropdown>
        ...
        >
            ...
            <div>
                ...
                <div class="admin-info-footer">
                    ...
                    <el-button @click="onLogout" type="danger" plain>{{ t('layouts.Exit') }}</el-button>
                </div>
            </div>
        </el-popover>
...
import {sysAdminLogout} from "/@/api/sys/admin";
